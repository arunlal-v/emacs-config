...
#* GENERAL KEYBINGINGS
  ...
  (nvmap :prefix "SPC"
    ...
    "h r r" '((lambda () (interactive) (load-file "~/.emacs.d/init.el")) :whick-key "Reload emacs configuration")
    ...
    ;;Windows motions
    "w h" '(evil-window-left :which-key "Goto left window")
    "w j" '(evil-window-down :which-key "Goto down window")
    "w k" '(evil-window-up :which-key "Goto up window")
    "w l" '(evil-window-right :which-key "Goto right window")
